...
def preprocess():
    ...
    #root = '/home/aadeshnpn/Documents/inspiringlab/dataset/'
    root = '/home/ilab/Documents/dataset2/'
    ...
    #return x_train,y_train,x_test,y_test,valid_set_x,valid_set_y
...
def train():
    ...
    train_gen, test_gen = preprocess()

    resnet50 = ResNet50(input_shape, classes)

    resnet50.summary()

    checkpointer = ModelCheckpoint(filepath="res_weight_23_checkpoint.h5", verbose=0, save_best_only=True)
    
    # Option 1: Load Weights + Architecture
    with open('res_model_23.json', 'r') as f:
        resnet50 = model_from_json(f.read())
    resnet50.load_weights('res_weight_23.h5')
    ...
    resnet50.fit_generator(
                ...
                # validation_steps = int(len(test_gen)/batch_size),
                # batch_size=batch_size,
                verbose = 1,
    ...
    with open("res_model_23.json", "w+") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    resnet50.save_weights("res_weight_23.h5")
